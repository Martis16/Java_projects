 ...
 * @author Martynas
 */
public class PlayerMapX<K,V> extends PlayerMap<K,V> implements MapADTx<K,V> {
     ...
     * @param baseObj
     */
    public PlayerMapX(K baseKey, V baseObj) {
     ...
     * @param ht
     */
    public PlayerMapX(K baseKey, V baseObj, HashType ht) {
     ...
     * @param ht
     */
    public PlayerMapX(K baseKey, V baseObj, int initialCapacity, HashType ht) {
     ...
     * @param ht
     */
    public PlayerMapX(K baseKey, V baseObj, int initialCapacity, float loadFactor, HashType ht) {
