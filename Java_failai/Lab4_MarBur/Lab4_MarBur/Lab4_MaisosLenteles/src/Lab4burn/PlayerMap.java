 ...
 * @author Martynas
 */
public class PlayerMap<K,V> implements MapADT<K,V>{
    ...
    public PlayerMap(HashType ht) {
        this(DEFAULT_INITIAL_CAPACITY, ht);
    }

    public PlayerMap(int initialCapacity, HashType ht) {
        this(initialCapacity, DEFAULT_LOAD_FACTOR, ht);
    }

    public PlayerMap(float loadFactor, HashType ht) {
        this(DEFAULT_INITIAL_CAPACITY, loadFactor, ht);
    }

    public PlayerMap(int initialCapacity, float loadFactor, HashType ht) {
   ...
   /**
    ...
    private void rehash(Node<K, V> node) {
        PlayerMap knygu_map
                = new PlayerMap(table.length * 2, loadFactor, ht);
