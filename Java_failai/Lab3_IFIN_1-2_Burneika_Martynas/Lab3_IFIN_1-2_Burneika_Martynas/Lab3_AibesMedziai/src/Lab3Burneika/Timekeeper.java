...
public class Timekeeper {
    ...
    private final String normFormatas = "%9.3f ";
    ...
    private void summary() throws InterruptedException {
        ...
        sb.append(String.format("       Bendras tyrimo laikas %8.4f sekundžių", totTime)).append("\n");
        sb.append(String.format("    Išmatuotas tyrimo laikas %8.4f sekundžių", sumTime)).append("\n");
